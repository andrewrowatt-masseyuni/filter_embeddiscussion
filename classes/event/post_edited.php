 ...
 */
class post_edited extends \core\event\base {
    /**
     * Init.
     */
    ...
    public static function get_name() {
        return get_string('event:post_edited', 'filter_embeddiscussion');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' edited post '{$this->objectid}'.";
    }
